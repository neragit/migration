...
<div className="w-full max-w-[90%] sm:max-w-2xl min-h-96 border-2 border-pink-600 mx-auto relative my-50 pt-8 pb-16 rounded-full text-center">

  {/* MIGRANTI */}
  <span className="block text-center text-2xl sm:text-3xl tracking-widest uppercase text-pink-600 font-normal mb-6 ">
    MIGRANTI
  </span>

  {/* TRAŽITELJI AZILA */}
<div className="absolute top-20 left-10 w-1/2 max-w-xs h-32 border-2 border-blue-600 p-4 rounded-full z-10">
  <div className="text-md uppercase tracking-wider text-blue-600 mb-2">
    TRAŽITELJI AZILA
  </div>

  {/* AZILANTI (podskup) */}
  <div className="absolute left-1/5 bottom-4 w-7/12 h-14 border-2 border-blue-800 p-2 rounded-full">
    <div className="text-sm uppercase tracking-wider text-blue-800">
      AZILANTI
    </div>
...
{/* IREGULARNI MIGRANTI — overlaps with TRAŽITELJI from right */}
<div className="absolute top-20 right-10 w-1/2 max-w-xs h-32 border-2 border-orange-600 p-4 rounded-full z-0 ">
  <div className="text-md uppercase tracking-wider text-orange-600">
    IREGULARNI MIGRANTI
  </div>
  <div className="text-sm opacity-70">
    (bez dozvole, "ilegalni")
  </div>
</div>

  {/* STRANI RADNICI — separate */}
  <div className="absolute left-1/2 -translate-x-1/2 bottom-6 w-3/5 max-w-xs h-32 border-2 border-green-600 p-4 rounded-full">
    <div className="text-md uppercase tracking-wider text-green-600">
      STRANI RADNICI
    </div>
    <div className="text-sm opacity-70">
      (legalni boravak i rad)
    </div>
  </div>
            ...
            <section className="w-full  ">
                ...
                <div className="text-center text-sm text-gray-500 mt-2">
                    Vizualizaciju je moguće uvećati. Podaci su prikupljeni u veljači 2026.
                </div>
            </section>
