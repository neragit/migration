        ...
        <>
            ...
            <section className=" my-30 " >
                ...
                <img
                    ...
                    width="900"
                    height="500"
                    className={`max-w-[1200px] mx-auto h-auto transition-opacity  duration-1000 ease-in
            ...
            <div className="w-full mx-auto max-w-4xl min-w-0 px-5 mt-20 text-gray-700    ">
                ...
                <section className="section mt-10">
                    ...
                    <h2>Procjena korisnika prema prošloj lokaciji</h2>

                    <p className="paragraph mt-10">
                        Meta API podaci prikazuju procjene broja osoba koje su živjele u određenoj zemlji (engl. "Lived in ... (Formerly Expats)"). Međutim, ti brojevi mogu uključivati i Hrvate koji su živjeli u inozemstvu i vratili se. Nije poznato kako točno Meta razlikuje turista od iseljenika, npr. koliko dugo osoba treba boraviti u inozemstvu. Možemo djelomično pretpostaviti koje zemlje objašnjavaju Hrvati (npr. prema Državnom zavodu za statistiku samo u 2024. je zabilježeno da je najviše Hrvata stiglo iz Njemačke (6336), Bosne i Hercegovine (1625), Austrije (1116) i Švicarske(611)). Drugi problem u interpretaciji proizlazi iz činjenice da Meta ne nudi kategorije za sve zemlje (npr. nedostaju Hrvatska, Bosna i Hercegovina, Makedonija, Albanija, Ukrajina, Egipat, Turska, Uzbekistan).
                    </p>

                    <h3 style={{ fontSize: '14px', fontWeight: 'bold' }}>
                        Procjena publike prema prošloj lokaciji na temelju pojedinačne pretrage putem Meta API-ja
                    </h3>
